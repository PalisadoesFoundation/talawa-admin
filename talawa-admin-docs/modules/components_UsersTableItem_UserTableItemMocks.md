...
[src/components/UsersTableItem/UserTableItemMocks.ts:7](https://github.com/disha1202/talawa-admin/blob/171fdd3/src/components/UsersTableItem/UserTableItemMocks.ts#L7)
