...
[src/components/UsersTableItem/UserTableItemMocks.ts:7](https://github.com/pateldivyesh1323/talawa-admin/blob/926c168/src/components/UsersTableItem/UserTableItemMocks.ts#L7)
