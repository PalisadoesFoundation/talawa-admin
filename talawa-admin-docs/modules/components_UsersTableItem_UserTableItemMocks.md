...
[src/components/UsersTableItem/UserTableItemMocks.ts:7](https://github.com/palisadoes/talawa-admin/blob/5828937/src/components/UsersTableItem/UserTableItemMocks.ts#L7)
