...
[src/components/UsersTableItem/UserTableItemMocks.ts:7](https://github.com/duplixx/talawa-admin/blob/032c596/src/components/UsersTableItem/UserTableItemMocks.ts#L7)
