...
[src/components/UsersTableItem/UserTableItemMocks.ts:7](https://github.com/pateldivyesh1323/talawa-admin/blob/cd0a761/src/components/UsersTableItem/UserTableItemMocks.ts#L7)
