...
[src/components/UsersTableItem/UserTableItemMocks.ts:7](https://github.com/meetulr/talawa-admin/blob/40ecfbe/src/components/UsersTableItem/UserTableItemMocks.ts#L7)
