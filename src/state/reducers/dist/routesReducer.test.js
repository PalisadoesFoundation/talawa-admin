...
var routesReducer_1 = require("./routesReducer");
describe('Testing Routes reducer', function () {
    it('should return the initial state', function () {
        expect_1["default"](routesReducer_1["default"](undefined, {
            type: '',
            payload: undefined
        })).toEqual({
            targets: [
    ...
    it('should handle UPDATE_P_TARGETS', function () {
        expect_1["default"](routesReducer_1["default"](undefined, {
