...
describe("Testing AddOnRegister", () => {
  ...
  test("should render modal and take info to add plugin for registered organization", () => {
    ...
    userEvent.type(screen.getByPlaceholderText("Ex. This plugin provides UI for ...."), "test description");
    userEvent.type(screen.getByPlaceholderText("Ex. Mr John Doe"), "test creator");
    userEvent.click(screen.getByTestId('addonregister'));
    userEvent.click(screen.getByTestId('addonclose'));
    
    expect(screen.getByPlaceholderText("Ex. Donations")).toHaveValue("myplugin");
    expect(screen.getByPlaceholderText("Ex. This plugin provides UI for ....")).toHaveValue("test description");
    expect(screen.getByPlaceholderText("Ex. Mr John Doe")).toHaveValue("test creator");
  })
})