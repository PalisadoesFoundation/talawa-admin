        ...
        <Provider store={store}>
          <BrowserRouter>
            <I18nextProvider i18n={i18nForTest}>
              <MockedProvider cache={cache} mocks={getCompletedAdvertisementMocks}>
                <Advertisement />
              </MockedProvider>
            </I18nextProvider>
          </BrowserRouter>
    ...
    render(
      <ApolloProvider client={client}>
        <Provider store={store}>
          <BrowserRouter>
            <I18nextProvider i18n={i18nForTest}>
              <MockedProvider cache={cache} mocks={filterActiveAdvertisementData}>
                <Advertisement />
              </MockedProvider>
            </I18nextProvider>
          </BrowserRouter>
    ...
    render(
      <ApolloProvider client={client}>
        <Provider store={store}>
          <BrowserRouter>
            <I18nextProvider i18n={i18nForTest}>
              <MockedProvider cache={cache} mocks={filterCompletedAdvertisementData}>
                <Advertisement />
              </MockedProvider>
            </I18nextProvider>
          </BrowserRouter>
    ...
    render(
      <ApolloProvider client={client}>
        <Provider store={store}>
          <BrowserRouter>
            <I18nextProvider i18n={i18nForTest}>
              <MockedProvider cache={cache} mocks={createAdvertisementWithoutName}>
                <Advertisement />
              </MockedProvider>
            </I18nextProvider>
          </BrowserRouter>
    ...
    render(
      <ApolloProvider client={client}>
        <Provider store={store}>
          <BrowserRouter>
            <I18nextProvider i18n={i18nForTest}>
              <MockedProvider cache={cache} mocks={createAdvertisementWithEndDateBeforeStart}>
                <Advertisement />
              </MockedProvider>
            </I18nextProvider>
          </BrowserRouter>
