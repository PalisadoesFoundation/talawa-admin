  ...
  const handleImageChange = async (
    ...
    if (file) {
      ...
      try {
        ...
        const { objectName } = await uploadFileToMinio(file, 'chats');
        setAttachment(objectName);
      } catch (error) {
          ...
          <div id="messageInput">
            ...
            {attachmentPreview && (
              <div className={styles.attachment}>
                ...
                <Button onClick={clearAttachment} className={styles.closeBtn}>
                  <Close />
                </Button>
              </div>
            )}
