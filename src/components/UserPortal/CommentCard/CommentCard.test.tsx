...
describe('Testing CommentCard Component [User Portal]', () => {
  ...
  test('Component renders as expected if user unlikes the comment.', async () => {
    ...
    const beforeUserId = localStorage.getItem('Talawa-admin_userId');
    localStorage.setItem('Talawa-admin_userId', '1');
    ...
    if (beforeUserId) {
      localStorage.setItem('Talawa-admin_userId', beforeUserId);
    }
  });
});
