/**
 * ActionsContent Component
 *
 * Renders the hierarchical navigation layout for selecting tags across folders
 * within the TagActions modal. It handles rendering breadcrumbs, folder trees,
 * and tag checkboxes dynamically based on the current search term and folder state.
 *
 * @param props - InterfaceTagActionsContentProps defining the current view and selection state.
 * @returns JSX Element for the content body of the Tag Actions Modal.
 */
...
const ActionsContent: React.FC<InterfaceTagActionsContentProps> = ({
  hasAssignees,
  currentFolderId,
  breadcrumbFolderIds,
  folderStateMap,
