/**
 * Unit tests for the PledgeModal component.
 *
 * Covers create, edit, and delete pledge flows including validation,
 * currency selection, amount handling, and error states.
 */
...
/**
 * Creates a mocked UPDATE_PLEDGE GraphQL response.
 *
 * @param variables - The mutation variables (id, amount, currency, etc.).
 * @param isError - When true the mock returns a network error.
...
/**
 * Creates a mocked CREATE_PLEDGE GraphQL response.
 *
 * @param variables - The mutation variables (campaignId, amount, pledgerId).
 * @param isError - When true the mock returns a network error.
 * @returns A MockedResponse suitable for MockedProvider.
 */
...
/**
 * Renders the PledgeModal component with the given Apollo link and props.
 *
 * @param link - The Apollo link providing mocked GraphQL responses.
 * @param props - Props forwarded to the PledgeModal component.
