    ...
    <section className={styles['pageNotFound']}>
      <div className={`${styles['container']} ${styles['text-center']}`}>
        <div className={styles['brand']}>
          <img src={Logo} alt="Logo" className={styles['img-fluid']} />
          {/* Display a message based on admin status */}
          {adminFor != undefined ? (
            <h3 className={`${styles['text-uppercase']} ${styles['mt-4']}`}>
        ...
        {adminFor != undefined ? (
          <Link
            to="/orglist"
            className={`${styles['btn']} ${styles['btn-outline-success']} ${styles['mt-3']}`}
          >
