...
describe('Organisations Page testing as SuperAdmin', () => {
  ...
  test('Create organization model should work properly', async () => {
    ...
    await user.click(screen.getByTestId(/createOrganizationBtn/i));
    ...
    await user.click(screen.getByTestId(/userRegistrationRequired/i));
    await user.click(screen.getByTestId(/visibleInSearch/i));
    ...
    await user.upload(displayImage, formData.image);
    fireEvent.submit(screen.getByTestId(/submitOrganizationForm/i));
    expect(
      await screen.findByText(/Congratulation the Organization is created/i),
    ).toBeInTheDocument();
  });
  ...
  test('Plugin Notification model should work properly', async () => {
    ...
    await user.click(screen.getByTestId(/submitOrganizationForm/i));
    // await act(async () => {
    ...
    await user.click(screen.getByTestId(/enableEverythingForm/i));
  });
  ...
  test('Testing create sample organization working properly', async () => {
    ...
    const user = userEvent.setup();
    await user.click(screen.getByTestId(/createOrganizationBtn/i));
    await user.click(screen.getByTestId(/createSampleOrganizationBtn/i));
    await waitFor(() =>
      expect(
