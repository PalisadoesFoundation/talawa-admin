        ...
        <div className="stats-grid">
          <div className="stat-card">
            <div className="stat-card-top">
              <span className="stat-card-label">{t('pledges.pledgedAmount')}</span>
            ...
            <div className="stat-card-value">
              {currencySymbol}{totalPledged.toLocaleString('en-US')}
            </div>
          ...
          <div className="stat-card">
            <div className="stat-card-top">
              <span className="stat-card-label">{t('pledges.raisedAmount')}</span>
            ...
            <div className="stat-card-value">
              {currencySymbol}{totalRaised.toLocaleString('en-US')}
            </div>
          ...
          <div className="stat-card">
            ...
            <div className="stat-card-value">
              {currencySymbol}{campaignInfo?.goal.toLocaleString('en-US')}
            </div>
            <div className="stat-card-change neutral">
              {t('pledges.endsOn')} {dayjs(campaignInfo?.endDate).format('DD/MM/YYYY')}
            </div>
          </div>
        </div>
