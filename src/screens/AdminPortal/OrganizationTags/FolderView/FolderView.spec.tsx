...
vi.mock(
  'components/AdminPortal/Tags/Modals/EditFolderModal/EditFolderModal',
  () => ({
    default: ({
      open,
      folder,
...
vi.mock('components/AdminPortal/Tags/Modals/EditTagModal/EditTagModal', () => ({
  default: ({
    open,
    tag,
    onClose,
...
describe('FolderView Component', () => {
  ...
  test('opens and closes manage child folder modal', async () => {
    ...
    const manageButtons = screen.getAllByRole('button', { name: /edit/i });
