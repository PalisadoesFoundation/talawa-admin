...
describe('OrgPost Component', () => {
  ...
  it('handles no file selected', async () => {
    ...
    render(
      <MockedProvider mocks={[...mocks, mockPinnedPostsForTest]}>
        <I18nextProvider i18n={i18n}>
          <MemoryRouter initialEntries={['/org/123']}>
            <Routes>
              <Route path="/org/:orgId" element={<OrgPost />} />
...
describe('Tests for sorting , nextpage , previousPage', () => {
  ...
  const renderComponent = (): RenderResult =>
    render(
      <MockedProvider mocks={[...baseMocks, ...mocks1]}>
        <I18nextProvider i18n={i18n}>
          <MemoryRouter initialEntries={['/org/123']}>
            <Routes>
              <Route path="/org/:orgId" element={<OrgPost />} />
  ...
  it('shows Loader when loading (delayed response)', async () => {
    render(
      <MockedProvider mocks={[...baseMocks, ...loadingMocks]}>
        <I18nextProvider i18n={i18n}>
          <MemoryRouter initialEntries={['/org/123']}>
            <Routes>
              <Route path="/org/:orgId" element={<OrgPost />} />
...
describe('OrgPost SearchBar functionality', () => {
  ...
  const renderWithMocks = (mocks: MockedResponse[]): RenderResult => {
    ...
    return render(
      <MockedProvider mocks={mocksWithPinnedPosts}>
        <I18nextProvider i18n={i18n}>
          <MemoryRouter initialEntries={['/org/123']}>
            <Routes>
              <Route path="/org/:orgId" element={<OrgPost />} />
...
describe('OrgPost Edge Cases', () => {
  ...
  it('handles pagination for sorted posts with sufficient data', async () => {
    ...
    render(
      <MockedProvider mocks={largeDataMocks}>
        <I18nextProvider i18n={i18n}>
          <MemoryRouter initialEntries={['/org/123']}>
            <Routes>
              <Route path="/org/:orgId" element={<OrgPost />} />
  ...
  it('handles sorting when postsByOrganization is missing', async () => {
    ...
    render(
      <MockedProvider mocks={[missingDataMock, ...baseMocks]}>
        <I18nextProvider i18n={i18n}>
          <MemoryRouter initialEntries={['/org/123']}>
            <Routes>
              <Route path="/org/:orgId" element={<OrgPost />} />
