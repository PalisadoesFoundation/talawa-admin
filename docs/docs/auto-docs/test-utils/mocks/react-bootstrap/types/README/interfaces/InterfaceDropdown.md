...
- `FC`\<[`DivProps`](test-utils\mocks\react-bootstrap\types\README\type-aliases\DivProps.md)\>
...
[`DivProps`](test-utils\mocks\react-bootstrap\types\README\type-aliases\DivProps.md)
...
> **Item**: `FC`\<[`BtnProps`](test-utils\mocks\react-bootstrap\types\README\type-aliases\BtnProps.md)\>
...
> **Menu**: `FC`\<[`DivProps`](test-utils\mocks\react-bootstrap\types\README\type-aliases\DivProps.md)\>
...
> **Toggle**: `FC`\<[`BtnProps`](test-utils\mocks\react-bootstrap\types\README\type-aliases\BtnProps.md)\>
