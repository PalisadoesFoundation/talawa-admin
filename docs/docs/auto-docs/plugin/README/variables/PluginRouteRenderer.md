...
> `const` **PluginRouteRenderer**: `React.FC`\<[`InterfacePluginRouteRendererProps`](types\shared-components\PluginRouteRenderer\interface\README\interfaces\InterfacePluginRouteRendererProps.md)\>
