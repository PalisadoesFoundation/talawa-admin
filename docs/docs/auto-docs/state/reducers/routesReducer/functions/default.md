...
[talawa-admin](../../../../modules.md) / [state/reducers/routesReducer](../README.md) / default

# Function: default()

> **default**(`state`, `action`): `object`

Defined in: [src/state/reducers/routesReducer.ts:16](https://github.com/bint-Eve/talawa-admin/blob/e05e1a03180dbbfc7ba850102958ea6b6cd4b01e/src/state/reducers/routesReducer.ts#L16)
