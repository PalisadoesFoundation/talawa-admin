...
> `const` **default**: `React.FC`\<[`InterfaceAssignmentTypeSelectorProps`](types\AdminPortal\AssignmentTypeSelector\interface\README\interfaces\InterfaceAssignmentTypeSelectorProps.md)\>
