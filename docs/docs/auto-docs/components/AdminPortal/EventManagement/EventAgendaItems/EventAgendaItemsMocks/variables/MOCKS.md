...
Defined in: [src/components/AdminPortal/EventManagement/EventAgendaItems/EventAgendaItemsMocks.ts:48](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/components/AdminPortal/EventManagement/EventAgendaItems/EventAgendaItemsMocks.ts#L48)
