...
> `const` **default**: `React.FC`\<[`InterfaceAgendaItemsUpdateModalProps`](types\AdminPortal\Agenda\interface\README\interfaces\InterfaceAgendaItemsUpdateModalProps.md)\>
