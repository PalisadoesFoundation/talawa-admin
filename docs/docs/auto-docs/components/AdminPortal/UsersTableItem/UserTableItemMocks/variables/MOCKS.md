...
Defined in: [src/components/AdminPortal/UsersTableItem/UserTableItemMocks.ts:7](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/components/AdminPortal/UsersTableItem/UserTableItemMocks.ts#L7)
