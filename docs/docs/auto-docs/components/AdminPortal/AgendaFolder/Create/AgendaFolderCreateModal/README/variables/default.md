...
> `const` **default**: `React.FC`\<[`InterfaceAgendaFolderCreateModalProps`](types\AdminPortal\Agenda\interface\README\interfaces\InterfaceAgendaFolderCreateModalProps.md)\>
