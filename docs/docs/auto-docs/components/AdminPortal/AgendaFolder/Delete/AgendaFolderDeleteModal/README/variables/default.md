...
> `const` **default**: `React.FC`\<[`InterfaceAgendaFolderDeleteModalProps`](types\AdminPortal\Agenda\interface\README\interfaces\InterfaceAgendaFolderDeleteModalProps.md)\>
