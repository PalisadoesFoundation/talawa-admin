...
> `const` **default**: `React.FC`\<[`InterfaceAgendaFolderUpdateModalProps`](types\AdminPortal\Agenda\interface\README\interfaces\InterfaceAgendaFolderUpdateModalProps.md)\>
