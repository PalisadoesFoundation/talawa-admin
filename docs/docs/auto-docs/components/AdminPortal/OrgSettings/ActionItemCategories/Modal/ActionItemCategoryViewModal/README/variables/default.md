...
> `const` **default**: `FC`\<[`ICategoryViewModalProps`](components\AdminPortal\OrgSettings\ActionItemCategories\Modal\ActionItemCategoryViewModal\README\interfaces\ICategoryViewModalProps.md)\>
