...
> `const` **default**: `React.FC`\<[`InterfaceAddOnSpotAttendeeProps`](types\AdminPortal\EventRegistrantsModal\AddOnSpot\README\interfaces\InterfaceAddOnSpotAttendeeProps.md)\>
