...
> `const` **default**: `React.FC`\<[`InterfaceInviteByEmailModalProps`](types\AdminPortal\EventRegistrantsModal\InviteByEmail\interface\README\interfaces\InterfaceInviteByEmailModalProps.md)\>
