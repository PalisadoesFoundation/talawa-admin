...
Defined in: [src/components/UsersTableItem/UserTableItemMocks.ts:80](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/components/UsersTableItem/UserTableItemMocks.ts#L80)
