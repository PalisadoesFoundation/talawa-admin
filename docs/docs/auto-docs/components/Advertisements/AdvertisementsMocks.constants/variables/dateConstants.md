...
Defined in: [src/components/Advertisements/AdvertisementsMocks.constants.ts:6](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/components/Advertisements/AdvertisementsMocks.constants.ts#L6)
...
AdvertisementsMocks.constants.ts

## Description

Constants for advertisement mocks.
