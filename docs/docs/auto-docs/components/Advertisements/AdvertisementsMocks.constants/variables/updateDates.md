...
Defined in: [src/components/Advertisements/AdvertisementsMocks.constants.ts:31](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/components/Advertisements/AdvertisementsMocks.constants.ts#L31)
