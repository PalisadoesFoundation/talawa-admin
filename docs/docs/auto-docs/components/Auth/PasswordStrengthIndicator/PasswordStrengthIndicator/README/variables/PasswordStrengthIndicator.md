...
> `const` **PasswordStrengthIndicator**: `React.FC`\<[`InterfacePasswordStrengthIndicatorProps`](types\Auth\PasswordStrengthIndicator\interface\README\interfaces\InterfacePasswordStrengthIndicatorProps.md)\>
