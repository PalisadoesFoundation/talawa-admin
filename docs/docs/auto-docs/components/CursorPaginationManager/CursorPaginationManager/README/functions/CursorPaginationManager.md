...
[`InterfaceCursorPaginationManagerProps`](types\CursorPagination\interface\README\interfaces\InterfaceCursorPaginationManagerProps.md)\<`TData`, `TNode`, `TVariables`\>
