...
Defined in: [src/components/EventCalender/EventCalenderMocks.ts:69](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/components/EventCalender/EventCalenderMocks.ts#L69)
