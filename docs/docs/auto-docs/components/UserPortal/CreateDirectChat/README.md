...
- [default](components\UserPortal\CreateDirectChat\README\functions\default.md)
- [handleCreateDirectChat](components\UserPortal\CreateDirectChat\README\functions\handleCreateDirectChat.md)
