...
# Variable: CHAT\_BY\_ID\_AFTER\_DELETE\_MOCK

> `const` **CHAT\_BY\_ID\_AFTER\_DELETE\_MOCK**: `object`

Defined in: [src/components/UserPortal/ChatRoom/ChatRoom.fixtures.ts:490](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/components/UserPortal/ChatRoom/ChatRoom.fixtures.ts#L490)
