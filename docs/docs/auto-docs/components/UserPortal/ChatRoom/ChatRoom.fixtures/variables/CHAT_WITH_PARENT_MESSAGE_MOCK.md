...
# Variable: CHAT\_WITH\_PARENT\_MESSAGE\_MOCK

> `const` **CHAT\_WITH\_PARENT\_MESSAGE\_MOCK**: `object`

Defined in: [src/components/UserPortal/ChatRoom/ChatRoom.fixtures.ts:556](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/components/UserPortal/ChatRoom/ChatRoom.fixtures.ts#L556)
