...
[`InterfaceLanguageSelectorProps`](types\UserPortal\UserPortalNavigationBar\interface\README\interfaces\InterfaceLanguageSelectorProps.md)
...
## See
 ...
 - [InterfaceLanguageSelectorProps](types\UserPortal\UserPortalNavigationBar\interface\README\interfaces\InterfaceLanguageSelectorProps.md) for detailed prop type definitions
 - [languages](utils\languages\README\variables\languages.md) for the list of supported languages
