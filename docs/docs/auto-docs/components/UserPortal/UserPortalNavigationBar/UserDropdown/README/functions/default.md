...
[`InterfaceUserDropdownProps`](types\UserPortal\UserPortalNavigationBar\interface\README\interfaces\InterfaceUserDropdownProps.md)
...
[InterfaceUserDropdownProps](types\UserPortal\UserPortalNavigationBar\interface\README\interfaces\InterfaceUserDropdownProps.md) for detailed prop type definitions
