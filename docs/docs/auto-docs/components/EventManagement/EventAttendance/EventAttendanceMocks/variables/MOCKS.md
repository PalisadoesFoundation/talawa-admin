...
Defined in: [src/components/EventManagement/EventAttendance/EventAttendanceMocks.ts:50](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/components/EventManagement/EventAttendance/EventAttendanceMocks.ts#L50)
