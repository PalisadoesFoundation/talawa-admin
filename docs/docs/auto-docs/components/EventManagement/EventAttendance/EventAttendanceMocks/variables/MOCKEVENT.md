...
Defined in: [src/components/EventManagement/EventAttendance/EventAttendanceMocks.ts:4](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/components/EventManagement/EventAttendance/EventAttendanceMocks.ts#L4)
