...
# Variable: EVENT\_DETAILS\_RECURRING\_MOCK

> `const` **EVENT\_DETAILS\_RECURRING\_MOCK**: `object`

Defined in: [src/components/EventManagement/EventRegistrant/EventRegistrants.mocks.ts:53](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/components/EventManagement/EventRegistrant/EventRegistrants.mocks.ts#L53)
