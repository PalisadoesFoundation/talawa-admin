...
> `const` **default**: `ForwardRefExoticComponent`\<[`InterfaceSearchToggleProps`](types\shared-components\DropDownButton\interface\README\interfaces\InterfaceSearchToggleProps.md) & `RefAttributes`\<`HTMLDivElement`\>\>
