...
> `const` **searchableOptionsForCoverage**: [`InterfaceDropDownOption`](types\shared-components\DropDownButton\interface\README\interfaces\InterfaceDropDownOption.md)[]
