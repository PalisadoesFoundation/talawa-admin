...
> `const` **disabledDropdownProps**: [`InterfaceDropDownButtonProps`](types\shared-components\DropDownButton\interface\README\interfaces\InterfaceDropDownButtonProps.md)
