...
> `const` **default**: `FC`\<[`IItemUpdateStatusModalProps`](shared-components\ActionItems\ActionItemUpdateModal\ActionItemUpdateStatusModal\README\interfaces\IItemUpdateStatusModalProps.md)\>
