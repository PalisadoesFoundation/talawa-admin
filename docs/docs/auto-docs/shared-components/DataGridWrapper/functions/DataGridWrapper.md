...
Defined in: [src/shared-components/DataGridWrapper/DataGridWrapper.tsx:40](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/shared-components/DataGridWrapper/DataGridWrapper.tsx#L40)
