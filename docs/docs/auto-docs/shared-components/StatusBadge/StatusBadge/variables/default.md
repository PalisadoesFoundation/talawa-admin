...
Defined in: [src/shared-components/StatusBadge/StatusBadge.tsx:70](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/shared-components/StatusBadge/StatusBadge.tsx#L70)
