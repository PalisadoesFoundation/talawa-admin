...
> `const` **NotificationToast**: [`InterfaceNotificationToastHelpers`](types\shared-components\NotificationToast\interface\README\interfaces\InterfaceNotificationToastHelpers.md)
