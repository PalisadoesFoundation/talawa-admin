...
Defined in: [src/shared-components/NotificationToast/NotificationToast.tsx:87](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/shared-components/NotificationToast/NotificationToast.tsx#L87)
