...
> `const` **default**: `React.FC`\<[`InterfaceSearchFilterBarProps`](types\shared-components\SearchFilterBar\interface\README\type-aliases\InterfaceSearchFilterBarProps.md)\>
