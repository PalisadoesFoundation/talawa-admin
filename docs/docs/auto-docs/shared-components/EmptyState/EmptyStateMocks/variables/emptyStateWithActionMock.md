...
# Variable: emptyStateWithActionMock

> `const` **emptyStateWithActionMock**: [`InterfaceEmptyStateProps`](../../../../types/shared-components/EmptyState/interface/interfaces/InterfaceEmptyStateProps.md)
