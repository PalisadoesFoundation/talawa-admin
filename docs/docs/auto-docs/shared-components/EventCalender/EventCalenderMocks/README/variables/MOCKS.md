...
Defined in: [src/shared-components/EventCalender/EventCalenderMocks.ts:77](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/shared-components/EventCalender/EventCalenderMocks.ts#L77)
