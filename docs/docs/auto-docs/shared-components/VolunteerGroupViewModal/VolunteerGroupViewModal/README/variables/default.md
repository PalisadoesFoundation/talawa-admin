...
> `const` **default**: `React.FC`\<[`InterfaceVolunteerGroupViewModalProps`](types\shared-components\VolunteerGroupViewModal\interface\README\interfaces\InterfaceVolunteerGroupViewModalProps.md)\>
