...
Defined in: [src/shared-components/Recurrence/RecurrenceFrequencySection.tsx:12](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/shared-components/Recurrence/RecurrenceFrequencySection.tsx#L12)
