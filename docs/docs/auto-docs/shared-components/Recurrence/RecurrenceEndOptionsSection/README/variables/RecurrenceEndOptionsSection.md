...
> `const` **RecurrenceEndOptionsSection**: `React.FC`\<[`InterfaceRecurrenceEndOptionsSectionProps`](types\shared-components\Recurrence\interface\README\interfaces\InterfaceRecurrenceEndOptionsSectionProps.md)\>
