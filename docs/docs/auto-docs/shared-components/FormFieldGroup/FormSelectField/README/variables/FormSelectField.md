...
> `const` **FormSelectField**: `React.FC`\<[`InterfaceFormSelectFieldProps`](types\shared-components\FormFieldGroup\interface\README\interfaces\InterfaceFormSelectFieldProps.md)\>
