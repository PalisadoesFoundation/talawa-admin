...
> `const` **FormCheckField**: `React.FC`\<[`InterfaceFormCheckFieldProps`](types\shared-components\FormFieldGroup\interface\README\interfaces\InterfaceFormCheckFieldProps.md)\>
