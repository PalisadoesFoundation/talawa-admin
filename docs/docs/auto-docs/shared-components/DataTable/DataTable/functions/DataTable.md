...
Defined in: [src/shared-components/DataTable/DataTable.tsx:34](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/shared-components/DataTable/DataTable.tsx#L34)
