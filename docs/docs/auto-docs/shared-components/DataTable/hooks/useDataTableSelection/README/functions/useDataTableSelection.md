...
[`IUseDataTableSelectionOptions`](types\shared-components\DataTable\hooks\README\interfaces\IUseDataTableSelectionOptions.md)\<`T`\>
...
> **currentSelection**: `Set`\<[`Key`](types\shared-components\DataTable\types\README\type-aliases\Key.md)\>
...
[`IBulkAction`](types\shared-components\DataTable\hooks\README\interfaces\IBulkAction.md)\<`T`\>
