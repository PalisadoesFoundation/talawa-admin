...
> **useSimpleTableData**\<`TRow`, `TData`\>(`result`, `options`): [`IUseSimpleTableDataResult`](shared-components\DataTable\hooks\useSimpleTableData\README\interfaces\IUseSimpleTableDataResult.md)\<`TRow`, `TData`\>
...
[`IUseSimpleTableDataOptions`](shared-components\DataTable\hooks\useSimpleTableData\README\interfaces\IUseSimpleTableDataOptions.md)\<`TRow`, `TData`\>

## Returns

[`IUseSimpleTableDataResult`](shared-components\DataTable\hooks\useSimpleTableData\README\interfaces\IUseSimpleTableDataResult.md)\<`TRow`, `TData`\>
