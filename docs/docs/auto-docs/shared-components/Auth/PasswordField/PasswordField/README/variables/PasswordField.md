...
> `const` **PasswordField**: `React.FC`\<[`InterfacePasswordFieldProps`](types\shared-components\Auth\PasswordField\interface\README\interfaces\InterfacePasswordFieldProps.md)\>
...
Component props (see [InterfacePasswordFieldProps](types\shared-components\Auth\PasswordField\interface\README\interfaces\InterfacePasswordFieldProps.md)): label, name, value, onChange,
