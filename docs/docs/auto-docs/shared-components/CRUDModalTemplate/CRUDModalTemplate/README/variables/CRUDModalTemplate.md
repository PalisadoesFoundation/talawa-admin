...
> `const` **CRUDModalTemplate**: `React.FC`\<[`InterfaceCRUDModalTemplateProps`](types\shared-components\CRUDModalTemplate\interface\README\interfaces\InterfaceCRUDModalTemplateProps.md)\>
