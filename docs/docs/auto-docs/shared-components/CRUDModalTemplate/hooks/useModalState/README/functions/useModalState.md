...
> **useModalState**(`initialState`): [`InterfaceUseModalStateReturn`](types\shared-components\CRUDModalTemplate\interface\README\interfaces\InterfaceUseModalStateReturn.md)
