...
- `Component`\<[`InterfaceErrorBoundaryWrapperProps`](types\shared-components\ErrorBoundaryWrapper\interface\README\interfaces\InterfaceErrorBoundaryWrapperProps.md), [`InterfaceErrorBoundaryWrapperState`](types\shared-components\ErrorBoundaryWrapper\interface\README\interfaces\InterfaceErrorBoundaryWrapperState.md)\>

## Constructors

### new ErrorBoundaryWrapper()
...
[`InterfaceErrorBoundaryWrapperProps`](types\shared-components\ErrorBoundaryWrapper\interface\README\interfaces\InterfaceErrorBoundaryWrapperProps.md)
...
> `static` **getDerivedStateFromError**(`error`): `Partial`\<[`InterfaceErrorBoundaryWrapperState`](types\shared-components\ErrorBoundaryWrapper\interface\README\interfaces\InterfaceErrorBoundaryWrapperState.md)\>
...
`Partial`\<[`InterfaceErrorBoundaryWrapperState`](types\shared-components\ErrorBoundaryWrapper\interface\README\interfaces\InterfaceErrorBoundaryWrapperState.md)\>
