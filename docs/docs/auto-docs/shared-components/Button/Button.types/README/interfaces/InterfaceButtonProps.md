...
> `optional` **iconPosition**: [`ButtonIconPosition`](shared-components\Button\Button.types\README\type-aliases\ButtonIconPosition.md)
...
> `optional` **size**: [`ButtonSize`](shared-components\Button\Button.types\README\type-aliases\ButtonSize.md)
...
> `optional` **variant**: [`ButtonVariant`](shared-components\Button\Button.types\README\type-aliases\ButtonVariant.md)
