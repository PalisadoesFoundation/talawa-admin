...
[`IAutocompleteProps`](types\shared-components\Autocomplete\interface\README\interfaces\IAutocompleteProps.md)\<`T`, `TMultiple`, `TDisableClearable`, `TFreeSolo`\>
...
- See [IAutocompleteProps](types\shared-components\Autocomplete\interface\README\interfaces\IAutocompleteProps.md) for full prop documentation
