...
Defined in: [src/shared-components/PeopleTable/PeopleTable.tsx:18](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/shared-components/PeopleTable/PeopleTable.tsx#L18)
...
The props for the PeopleTable component.

## Returns

The rendered PeopleTable component.
