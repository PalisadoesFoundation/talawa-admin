...
> **handleOAuthLogin**(`client`, `provider`, `authorizationCode`, `redirectUri`): `Promise`\<[`InterfaceAuthenticationPayload`](types\Auth\auth\README\interfaces\InterfaceAuthenticationPayload.md)\>
...
[`OAuthProviderKey`](types\Auth\auth\README\type-aliases\OAuthProviderKey.md)
...
`Promise`\<[`InterfaceAuthenticationPayload`](types\Auth\auth\README\interfaces\InterfaceAuthenticationPayload.md)\>
