...
> **usePasswordVisibility**(`initialVisible`): [`IUsePasswordVisibilityReturn`](types\Auth\usePasswordVisibility\README\interfaces\IUsePasswordVisibilityReturn.md)
...
[`IUsePasswordVisibilityReturn`](types\Auth\usePasswordVisibility\README\interfaces\IUsePasswordVisibilityReturn.md)
