...
[`IUseLoginOptions`](types\Auth\useLogin\interface\README\interfaces\IUseLoginOptions.md)
...
> **login**: (`credentials`) => `Promise`\<[`InterfaceSignInResult`](types\Auth\LoginForm\interface\README\interfaces\InterfaceSignInResult.md)\>

#### Parameters

##### credentials

[`ILoginCredentials`](types\Auth\useLogin\interface\README\interfaces\ILoginCredentials.md)

#### Returns

`Promise`\<[`InterfaceSignInResult`](types\Auth\LoginForm\interface\README\interfaces\InterfaceSignInResult.md)\>
