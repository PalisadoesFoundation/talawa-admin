...
[`RegistrationErrorCodeType`](hooks\auth\useRegistration\README\type-aliases\RegistrationErrorCodeType.md)
...
> `readonly` **code**: [`RegistrationErrorCodeType`](hooks\auth\useRegistration\README\type-aliases\RegistrationErrorCodeType.md)
