...
> `const` **default**: `React.FC`\<[`InterfaceRecurringEventVolunteerModalProps`](types\UserPortal\RecurringEventVolunteerModal\interface\README\interfaces\InterfaceRecurringEventVolunteerModalProps.md)\>
