...
> `const` **updateMock**: `object`[]

Defined in: [src/screens/UserPortal/Settings/SettingsMocks.ts:125](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/screens/UserPortal/Settings/SettingsMocks.ts#L125)
