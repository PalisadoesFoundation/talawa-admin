...
> `const` **MOCKS**: (\{ `request`: \{ `query`: `DocumentNode`; `variables`: \{ `id`: `string`; \}; \}; `result`: \{ `data`: \{ `organizations`: `object`[]; \}; \}; \} \| \{ `request`: \{ `query`: `DocumentNode`; `variables`: \{ `id`: `undefined`; `pledgeOrderBy`: `string`; `where`: \{ `id`: `string`; \}; \}; \}; `result`: \{ `data`: \{ `deleteFundCampaignPledge`: `undefined`; `getFundraisingCampaigns`: `object`[]; \}; \}; \} \| \{ `request`: \{ `query`: `DocumentNode`; `variables`: \{ `id`: `string`; `pledgeOrderBy`: `undefined`; `where`: `undefined`; \}; \}; `result`: \{ `data`: \{ `deleteFundCampaignPledge`: \{ `id`: `string`; \}; `getFundraisingCampaigns`: `undefined`; \}; \}; \})[]
