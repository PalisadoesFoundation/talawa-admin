...
The pledge object to be edited, or `null` if creating a new pledge.
...
The end date of the campaign to ensure pledge dates are within this range.

## Param

The mode indicating whether the modal is for creating a new pledge or editing an existing one.
