...
> `const` **default**: `React.FC`\<[`InterfaceRemoveUserTagModalProps`](screens\AdminPortal\ManageTag\removeModal\RemoveUserTagModal\README\interfaces\InterfaceRemoveUserTagModalProps.md)\>
