...
> `const` **default**: `React.FC`\<[`InterfaceEditUserTagModalProps`](screens\AdminPortal\ManageTag\editModal\EditUserTagModal\README\interfaces\InterfaceEditUserTagModalProps.md)\>
