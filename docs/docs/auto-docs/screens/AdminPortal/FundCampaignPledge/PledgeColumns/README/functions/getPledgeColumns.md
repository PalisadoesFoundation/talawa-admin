...
> **getPledgeColumns**(`props`): [`TokenAwareGridColDef`](types\DataGridWrapper\interface\README\type-aliases\TokenAwareGridColDef.md)[]
...
[`TokenAwareGridColDef`](types\DataGridWrapper\interface\README\type-aliases\TokenAwareGridColDef.md)[]
