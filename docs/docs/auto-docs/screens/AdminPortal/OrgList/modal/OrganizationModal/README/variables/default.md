...
> `const` **default**: `React.FC`\<[`InterfaceOrganizationModalProps`](screens\AdminPortal\OrgList\modal\OrganizationModal\README\interfaces\InterfaceOrganizationModalProps.md)\>
