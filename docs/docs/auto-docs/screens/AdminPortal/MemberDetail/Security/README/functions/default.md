...
current password. The component opens a [PasswordUpdateModal](shared-components\Auth\PasswordUpdate\PasswordUpdateModal\README\variables\PasswordUpdateModal.md) for handling
