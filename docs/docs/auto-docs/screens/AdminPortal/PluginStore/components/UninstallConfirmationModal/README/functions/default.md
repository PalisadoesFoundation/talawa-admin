...
[`IUninstallConfirmationModalProps`](types\AdminPortal\PluginStore\UninstallConfirmationModal\interface\README\interfaces\IUninstallConfirmationModalProps.md)
