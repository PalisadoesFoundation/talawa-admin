...
> `const` **default**: `React.FC`\<[`InterfaceVolunteerGroupModal`](screens\AdminPortal\EventVolunteers\VolunteerGroups\modal\VolunteerGroupModal\README\interfaces\InterfaceVolunteerGroupModal.md)\>
