...
Defined in: [src/types/AdminSearchFilterBar/interface.ts:409](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/types/AdminSearchFilterBar/interface.ts#L409)
