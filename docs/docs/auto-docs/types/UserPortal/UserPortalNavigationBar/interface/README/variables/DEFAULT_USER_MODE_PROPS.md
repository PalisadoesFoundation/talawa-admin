...
> `const` **DEFAULT\_USER\_MODE\_PROPS**: `Partial`\<[`InterfaceUserPortalNavbarProps`](types\UserPortal\UserPortalNavigationBar\interface\README\interfaces\InterfaceUserPortalNavbarProps.md)\>
