...
> `optional` **branding**: [`BrandingConfig`](types\UserPortal\UserPortalNavigationBar\types\README\type-aliases\BrandingConfig.md)
...
> `optional` **navigationLinks**: [`NavigationLink`](types\UserPortal\UserPortalNavigationBar\types\README\type-aliases\NavigationLink.md)[]
...
[`NavigationLink`](types\UserPortal\UserPortalNavigationBar\types\README\type-aliases\NavigationLink.md)
