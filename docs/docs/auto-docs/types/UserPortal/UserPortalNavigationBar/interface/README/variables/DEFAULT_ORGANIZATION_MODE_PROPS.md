...
> `const` **DEFAULT\_ORGANIZATION\_MODE\_PROPS**: `Partial`\<[`InterfaceUserPortalNavbarProps`](types\UserPortal\UserPortalNavigationBar\interface\README\interfaces\InterfaceUserPortalNavbarProps.md)\>
