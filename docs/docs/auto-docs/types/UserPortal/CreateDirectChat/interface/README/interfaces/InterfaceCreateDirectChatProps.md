...
> **chats**: [`Chat`](types\UserPortal\Chat\interface\README\type-aliases\Chat.md)[]
...
> **chatsListRefetch**: [`ChatsListRefetch`](types\UserPortal\CreateDirectChat\interface\README\type-aliases\ChatsListRefetch.md)
