...
> **chat**: [`Chat`](types\UserPortal\Chat\interface\README\type-aliases\Chat.md)
...
> **chatRefetch**: (`variables`?) => `Promise`\<`ApolloQueryResult`\<\{ `chat`: [`Chat`](types\UserPortal\Chat\interface\README\type-aliases\Chat.md); \}\>\>
...
`Promise`\<`ApolloQueryResult`\<\{ `chat`: [`Chat`](types\UserPortal\Chat\interface\README\type-aliases\Chat.md); \}\>\>
