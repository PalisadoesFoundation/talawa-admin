...
[`IRegistrationSuccessResult`](hooks\auth\useRegistration\README\interfaces\IRegistrationSuccessResult.md)
...
> **organizations**: [`InterfaceOrgOption`](types\Auth\OrgSelector\interface\README\interfaces\InterfaceOrgOption.md)[]
