...
Defined in: [src/types/ProfileDropdown/interface.ts:6](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/types/ProfileDropdown/interface.ts#L6)
...
Defined in: [src/types/ProfileDropdown/interface.ts:12](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/types/ProfileDropdown/interface.ts#L12)
