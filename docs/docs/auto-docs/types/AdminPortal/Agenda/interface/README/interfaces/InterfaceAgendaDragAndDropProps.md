...
> **folders**: [`InterfaceAgendaFolderInfo`](types\AdminPortal\Agenda\interface\README\interfaces\InterfaceAgendaFolderInfo.md)[]
...
[`InterfaceAgendaFolderInfo`](types\AdminPortal\Agenda\interface\README\interfaces\InterfaceAgendaFolderInfo.md)
...
[`InterfaceAgendaItemInfo`](types\AdminPortal\Agenda\interface\README\interfaces\InterfaceAgendaItemInfo.md)
...
> **setFolders**: `Dispatch`\<`SetStateAction`\<[`InterfaceAgendaFolderInfo`](types\AdminPortal\Agenda\interface\README\interfaces\InterfaceAgendaFolderInfo.md)[]\>\>
