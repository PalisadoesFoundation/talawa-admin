...
> **createdBy**: [`User`](types\shared-components\User\type\README\type-aliases\User.md)
...
> **organization**: [`Organization`](types\AdminPortal\Organization\type\README\type-aliases\Organization.md)
...
> `optional` **updatedBy**: [`User`](types\shared-components\User\type\README\type-aliases\User.md)
