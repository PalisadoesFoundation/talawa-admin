...
> `optional` **actions**: [`InterfaceActionButton`](types\AdminPortal\UserTableRow\interface\README\interfaces\InterfaceActionButton.md)[]
...
[`InterfaceUserInfo`](types\AdminPortal\UserTableRow\interface\README\interfaces\InterfaceUserInfo.md)
...
> **user**: [`InterfaceUserInfo`](types\AdminPortal\UserTableRow\interface\README\interfaces\InterfaceUserInfo.md)
