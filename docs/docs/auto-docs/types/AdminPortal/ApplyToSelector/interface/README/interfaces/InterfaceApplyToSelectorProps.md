...
> **applyTo**: [`ApplyToType`](types\AdminPortal\ApplyToSelector\interface\README\type-aliases\ApplyToType.md)
...
[`ApplyToType`](types\AdminPortal\ApplyToSelector\interface\README\type-aliases\ApplyToType.md)
