...
> `optional` **actionItemCategory**: [`ActionItemCategory`](types\AdminPortal\actionItem\README\type-aliases\ActionItemCategory.md)
...
> `optional` **assignee**: [`User`](types\shared-components\User\type\README\type-aliases\User.md)
...
> `optional` **assigner**: [`User`](types\shared-components\User\type\README\type-aliases\User.md)
