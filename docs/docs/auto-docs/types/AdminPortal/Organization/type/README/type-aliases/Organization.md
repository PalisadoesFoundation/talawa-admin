...
> `optional` **actionItemCategories**: [`ActionItemCategory`](types\AdminPortal\actionItem\README\type-aliases\ActionItemCategory.md)[]
...
> `optional` **address**: [`Address`](types\AdminPortal\address\README\type-aliases\Address.md)
...
> `optional` **admins**: [`User`](types\shared-components\User\type\README\type-aliases\User.md)[]
...
> `optional` **agendaCategories**: [`AgendaCategory`](types\AdminPortal\Agenda\type\README\type-aliases\AgendaCategory.md)[]
...
> `optional` **blockedUsers**: [`User`](types\shared-components\User\type\README\type-aliases\User.md)[]
...
> `optional` **creator**: [`User`](types\shared-components\User\type\README\type-aliases\User.md)
...
> **customFields**: [`OrganizationCustomField`](types\AdminPortal\Organization\type\README\type-aliases\OrganizationCustomField.md)[]
...
> `optional` **members**: [`User`](types\shared-components\User\type\README\type-aliases\User.md)[]
...
> `optional` **membershipRequests**: [`MembershipRequest`](types\AdminPortal\membership\README\type-aliases\MembershipRequest.md)[]
...
> `optional` **venues**: [`Venue`](types\AdminPortal\venue\README\type-aliases\Venue.md)[]
