...
> **attendees**: [`InterfaceGQLUser`](types\AdminPortal\UserDetails\UserEvent\interface\README\interfaces\InterfaceGQLUser.md)[]
...
> **creator**: [`InterfaceGQLUser`](types\AdminPortal\UserDetails\UserEvent\interface\README\interfaces\InterfaceGQLUser.md) & `object`
...
> **eventsAttended**: [`InterfaceGQLEventLite`](types\AdminPortal\UserDetails\UserEvent\interface\README\interfaces\InterfaceGQLEventLite.md)[]
...
> **organization**: [`InterfaceGQLOrganization`](types\AdminPortal\UserDetails\UserEvent\interface\README\interfaces\InterfaceGQLOrganization.md)
