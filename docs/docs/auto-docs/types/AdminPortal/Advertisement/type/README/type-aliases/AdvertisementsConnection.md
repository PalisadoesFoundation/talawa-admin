...
> `optional` **edges**: [`AdvertisementEdge`](types\AdminPortal\Advertisement\type\README\type-aliases\AdvertisementEdge.md)[]
...
> `optional` **pageInfo**: [`DefaultConnectionPageInfo`](types\AdminPortal\pagination\README\type-aliases\DefaultConnectionPageInfo.md)
