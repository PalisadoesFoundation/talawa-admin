...
[`IDateRangeValue`](types\shared-components\DateRangePicker\interface\README\interfaces\IDateRangeValue.md)
...
> `optional` **presets**: [`IDateRangePreset`](types\shared-components\DateRangePicker\interface\README\interfaces\IDateRangePreset.md)[]
...
> **value**: [`IDateRangeValue`](types\shared-components\DateRangePicker\interface\README\interfaces\IDateRangeValue.md)
