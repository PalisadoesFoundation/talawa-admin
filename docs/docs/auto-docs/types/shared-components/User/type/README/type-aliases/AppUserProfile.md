...
> **adminFor**: [`Organization`](types\AdminPortal\Organization\type\README\type-aliases\Organization.md)[]
...
> **createdOrganizations**: [`Organization`](types\AdminPortal\Organization\type\README\type-aliases\Organization.md)[]
...
> **userId**: [`User`](types\shared-components\User\type\README\type-aliases\User.md)
