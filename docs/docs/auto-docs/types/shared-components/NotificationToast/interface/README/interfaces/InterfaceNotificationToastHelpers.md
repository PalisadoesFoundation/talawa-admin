...
[`NotificationToastMessage`](types\shared-components\NotificationToast\interface\README\type-aliases\NotificationToastMessage.md)
...
[`PromiseFunction`](types\shared-components\NotificationToast\interface\README\type-aliases\PromiseFunction.md)\<`T`\>

##### messages

[`InterfacePromiseMessages`](types\shared-components\NotificationToast\interface\README\interfaces\InterfacePromiseMessages.md)
