...
> **error**: [`NotificationToastMessage`](types\shared-components\NotificationToast\interface\README\type-aliases\NotificationToastMessage.md)
...
> **pending**: [`NotificationToastMessage`](types\shared-components\NotificationToast\interface\README\type-aliases\NotificationToastMessage.md)
...
> **success**: [`NotificationToastMessage`](types\shared-components\NotificationToast\interface\README\type-aliases\NotificationToastMessage.md)
