...
> `optional` **fallbackComponent**: `ComponentType`\<[`InterfaceErrorFallbackProps`](types\shared-components\ErrorBoundaryWrapper\interface\README\interfaces\InterfaceErrorFallbackProps.md)\>
