...
> **InterfaceSearchFilterBarProps** = [`InterfaceSearchFilterBarSimple`](types\shared-components\SearchFilterBar\interface\README\interfaces\InterfaceSearchFilterBarSimple.md) \| [`InterfaceSearchFilterBarAdvanced`](types\shared-components\SearchFilterBar\interface\README\interfaces\InterfaceSearchFilterBarAdvanced.md)
