...
> **dropdowns**: [`InterfaceDropdownConfig`](types\shared-components\SearchFilterBar\interface\README\interfaces\InterfaceDropdownConfig.md)[]
...
> `optional` **translations**: [`InterfaceSearchFilterBarTranslations`](types\shared-components\SearchFilterBar\interface\README\interfaces\InterfaceSearchFilterBarTranslations.md)
