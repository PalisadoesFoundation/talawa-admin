...
> **eventListCardProps**: [`InterfaceEventListCard`](types\shared-components\EventListCard\interface\README\interfaces\InterfaceEventListCard.md)
...
> **formState**: [`InterfaceFormState`](types\shared-components\EventListCard\interface\README\interfaces\InterfaceFormState.md)
