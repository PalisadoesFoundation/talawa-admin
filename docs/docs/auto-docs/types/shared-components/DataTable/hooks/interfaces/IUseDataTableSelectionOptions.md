...
Defined in: [src/types/shared-components/DataTable/hooks.ts:210](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/types/shared-components/DataTable/hooks.ts#L210)
