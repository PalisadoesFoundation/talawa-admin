...
> `optional` **bulkActions**: readonly [`IBulkAction`](types\shared-components\DataTable\hooks\README\interfaces\IBulkAction.md)\<`T`\>[]
...
> **keysOnPage**: [`Key`](types\shared-components\DataTable\types\README\type-aliases\Key.md)[]
