...
> `optional` **activeSortDir**: [`SortDirection`](types\shared-components\DataTable\types\README\type-aliases\SortDirection.md)
...
> **currentSelection**: `ReadonlySet`\<[`Key`](types\shared-components\DataTable\types\README\type-aliases\Key.md)\>
...
> **effectiveRowActions**: readonly [`IRowAction`](types\shared-components\DataTable\hooks\README\interfaces\IRowAction.md)\<`T`\>[]
...
[`IColumnDef`](types\shared-components\DataTable\column\README\interfaces\IColumnDef.md)\<`T`, `unknown`\>
...
[`Key`](types\shared-components\DataTable\types\README\type-aliases\Key.md)
