...
> `optional` **actionableRows**: `ReadonlySet`\<[`Key`](types\shared-components\DataTable\types\README\type-aliases\Key.md)\>
...
> `optional` **bulkActions**: `ReadonlyArray`\<[`IBulkAction`](types\shared-components\DataTable\hooks\README\interfaces\IBulkAction.md)\<`T`\>\>
...
> **columns**: [`IColumnDef`](types\shared-components\DataTable\column\README\interfaces\IColumnDef.md)\<`T`, `unknown`\>[]
...
> `optional` **initialSelectedKeys**: `ReadonlySet`\<[`Key`](types\shared-components\DataTable\types\README\type-aliases\Key.md)\>
...
> `optional` **initialSortDirection**: [`SortDirection`](types\shared-components\DataTable\types\README\type-aliases\SortDirection.md)
...
> `optional` **keysToShowRows**: `ReadonlySet`\<[`Key`](types\shared-components\DataTable\types\README\type-aliases\Key.md)\>
...
`ReadonlySet`\<[`Key`](types\shared-components\DataTable\types\README\type-aliases\Key.md)\>
...
[`ISortChangeEvent`](types\shared-components\DataTable\types\README\interfaces\ISortChangeEvent.md)\<`T`\>
...
> `optional` **pageInfo**: [`InterfacePageInfo`](types\shared-components\DataTable\pagination\README\interfaces\InterfacePageInfo.md) \| `null`
...
> `optional` **rowActions**: `ReadonlyArray`\<[`IRowAction`](types\shared-components\DataTable\hooks\README\interfaces\IRowAction.md)\<`T`\>\>
...
> `optional` **rowKey**: keyof `T` \| (`row`) => [`Key`](types\shared-components\DataTable\types\README\type-aliases\Key.md)
...
> `optional` **searchBarProps**: `Omit`\<[`InterfaceSearchBarProps`](types\shared-components\DataTable\props\README\interfaces\InterfaceSearchBarProps.md), `"value"` \| `"onChange"`\>
...
> `optional` **selectedKeys**: `ReadonlySet`\<[`Key`](types\shared-components\DataTable\types\README\type-aliases\Key.md)\>
...
> `optional` **selectedRows**: `ReadonlySet`\<[`Key`](types\shared-components\DataTable\types\README\type-aliases\Key.md)\>
...
> `optional` **sortBy**: [`ISortState`](types\shared-components\DataTable\types\README\interfaces\ISortState.md)[]
...
> `optional` **sortState**: [`ISortState`](types\shared-components\DataTable\types\README\interfaces\ISortState.md)
