...
> `optional` **filters**: [`IFilterState`](types\shared-components\DataTable\types\README\interfaces\IFilterState.md)[]
...
> `optional` **sorting**: [`ISortState`](types\shared-components\DataTable\types\README\interfaces\ISortState.md)[]
