...
> **column**: [`IColumnDef`](types\shared-components\DataTable\column\README\interfaces\IColumnDef.md)\<`T`, `unknown`\>
...
> **sortBy**: [`ISortState`](types\shared-components\DataTable\types\README\interfaces\ISortState.md)[]
...
> **sortDirection**: [`SortDirection`](types\shared-components\DataTable\types\README\type-aliases\SortDirection.md)
