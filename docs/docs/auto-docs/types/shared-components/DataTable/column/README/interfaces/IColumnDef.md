...
> **accessor**: [`Accessor`](types\shared-components\DataTable\types\README\type-aliases\Accessor.md)\<`T`, `TValue`\>
...
> **header**: [`HeaderRender`](types\shared-components\DataTable\types\README\type-aliases\HeaderRender.md)
