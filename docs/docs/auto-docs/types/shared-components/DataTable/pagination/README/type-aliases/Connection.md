...
> **Connection**\<`TNode`\> = \{ `edges`: [`Edge`](types\shared-components\DataTable\pagination\README\type-aliases\Edge.md)\<`TNode`\>[] \| `null`; `pageInfo`: [`PageInfo`](types\shared-components\DataTable\pagination\README\type-aliases\PageInfo.md) \| `null`; \} \| `null` \| `undefined`
...
\{ `edges`: [`Edge`](types\shared-components\DataTable\pagination\README\type-aliases\Edge.md)\<`TNode`\>[] \| `null`; `pageInfo`: [`PageInfo`](types\shared-components\DataTable\pagination\README\type-aliases\PageInfo.md) \| `null`; \}

### edges?

> `optional` **edges**: [`Edge`](types\shared-components\DataTable\pagination\README\type-aliases\Edge.md)\<`TNode`\>[] \| `null`

Array of edges, each optionally containing a node

### pageInfo?

> `optional` **pageInfo**: [`PageInfo`](types\shared-components\DataTable\pagination\README\type-aliases\PageInfo.md) \| `null`
