...
> `optional` **maxWidth**: `number` \| [`SpacingToken`](utils\tokenValues\README\type-aliases\SpacingToken.md)

Maximum column width - accepts number (pixels) or spacing token name

### minWidth?

> `optional` **minWidth**: `number` \| [`SpacingToken`](utils\tokenValues\README\type-aliases\SpacingToken.md)

Minimum column width - accepts number (pixels) or spacing token name

### width?

> `optional` **width**: `number` \| [`SpacingToken`](utils\tokenValues\README\type-aliases\SpacingToken.md)
