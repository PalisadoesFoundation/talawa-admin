...
> `optional` **columns**: [`TokenAwareGridColDef`](types\DataGridWrapper\interface\README\type-aliases\TokenAwareGridColDef.md)\<`GridValidRowModel`, `unknown`, `unknown`\>[]
...
> `optional` **emptyStateProps**: [`InterfaceEmptyStateProps`](types\shared-components\EmptyState\interface\README\interfaces\InterfaceEmptyStateProps.md)
