...
> `optional` **actionRef**: `Ref`\<[`InterfaceCursorPaginationManagerRef`](types\CursorPagination\interface\README\interfaces\InterfaceCursorPaginationManagerRef.md)\<`TNode`\>\>
