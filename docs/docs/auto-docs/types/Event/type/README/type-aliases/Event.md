...
> **actionItems**: [`ActionItem`](types\AdminPortal\actionItem\README\type-aliases\ActionItem.md)[]
...
> **attendeesCheckInStatus**: [`CheckInStatus`](types\shared-components\CheckIn\type\README\type-aliases\CheckInStatus.md)[]
...
> `optional` **organization**: [`Organization`](types\AdminPortal\Organization\type\README\type-aliases\Organization.md)
