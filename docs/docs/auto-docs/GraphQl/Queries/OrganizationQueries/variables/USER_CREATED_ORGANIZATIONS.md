...
Defined in: [src/GraphQl/Queries/OrganizationQueries.ts:292](https://github.com/PalisadoesFoundation/talawa-admin/blob/main/src/GraphQl/Queries/OrganizationQueries.ts#L292)
