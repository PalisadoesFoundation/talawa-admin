...
[talawa-admin](../../../../README.md) / [GraphQl/Queries/PlugInQueries](../README.md) / CHAT\_BY\_ID

# Variable: CHAT\_BY\_ID

> `const` **CHAT\_BY\_ID**: `DocumentNode`

Defined in: [src/GraphQl/Queries/PlugInQueries.ts:156](https://github.com/gautam-divyanshu/talawa-admin/blob/9fec1eef6a4674b14f6abe30e3be3844537d8dc2/src/GraphQl/Queries/PlugInQueries.ts#L156)
