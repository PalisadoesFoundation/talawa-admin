...
[talawa-admin](../../../../modules.md) / [GraphQl/Queries/PlugInQueries](../README.md) / ORGANIZATION\_CUSTOM\_FIELDS

# Variable: ORGANIZATION\_CUSTOM\_FIELDS

> `const` **ORGANIZATION\_CUSTOM\_FIELDS**: `DocumentNode`

Defined in: [src/GraphQl/Queries/PlugInQueries.ts:379](https://github.com/bint-Eve/talawa-admin/blob/e05e1a03180dbbfc7ba850102958ea6b6cd4b01e/src/GraphQl/Queries/PlugInQueries.ts#L379)
