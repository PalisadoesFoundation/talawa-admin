...
[talawa-admin](../../../../README.md) / [GraphQl/Mutations/FundMutation](../README.md) / CREATE\_FUND\_MUTATION

# Variable: CREATE\_FUND\_MUTATION

> `const` **CREATE\_FUND\_MUTATION**: `DocumentNode`

Defined in: [src/GraphQl/Mutations/FundMutation.ts:14](https://github.com/gautam-divyanshu/talawa-admin/blob/619e831a8e34de2906df3277eb6df8b5309fb2fc/src/GraphQl/Mutations/FundMutation.ts#L14)
